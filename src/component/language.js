...
3.3 分红池资金支出（2022 Q1上线）：①理事分红：每月1日12:00 UTC，SERO和UCON分红池中各36%资金将被自动执行分红至每位基金会理事账户，按照各账户平均权重比例加权分配（平均权重比例=每时刻权重比例总和/总时长）；②燃烧回购：每月11次随机时间，每次自动提取SERO分红池中当前量的6%，自动回购及燃烧UCON；③基金会的发展运营资金，可通过治理提案在SERO和UCON分红池中支出。    
